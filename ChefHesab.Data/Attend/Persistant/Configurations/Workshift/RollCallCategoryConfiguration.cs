...
{
    // RollCallCategory
    public class RollCallCategoryConfiguration : IEntityTypeConfiguration<RollCallCategory>
    {
        public void Configure(EntityTypeBuilder<RollCallCategory> builder)
        {
            builder.ToTable("RollCallCategory", "dbo");
            builder.HasKey(x => x.Id).HasName("PK_RollCallcategory").IsClustered();
            ...
            builder.Property(x => x.ColorCode).HasColumnName(@"ColorCode").HasColumnType("nvarchar(10)").IsRequired(false).HasMaxLength(10);
