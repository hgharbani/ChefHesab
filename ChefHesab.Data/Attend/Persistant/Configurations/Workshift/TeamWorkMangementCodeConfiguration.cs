...
namespace Ksc.HR.Data.Persistant.Configurations
{
    ...
    public class TeamWorkMangementCodeConfiguration : IEntityTypeConfiguration<TeamWorkMangementCode>
    {
        public void Configure(EntityTypeBuilder<TeamWorkMangementCode> builder)
        {
            builder.ToTable("TeamWorkMangementCode", "dbo");
            builder.HasKey(x => x.Id).HasName("PK_TeamWorkMangementCode").IsClustered();
