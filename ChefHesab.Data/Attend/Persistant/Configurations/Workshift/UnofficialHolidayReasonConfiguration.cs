...
namespace Ksc.HR.Data.Persistant.Configurations
{
    ...
    public class UnofficialHolidayReasonConfiguration : IEntityTypeConfiguration<UnofficialHolidayReason>
    {
        public void Configure(EntityTypeBuilder<UnofficialHolidayReason> builder)
        {
            builder.ToTable("UnofficialHolidayReason", "dbo");
            builder.HasKey(x => x.Id).HasName("PK_UnOfficialHoliday").IsClustered();
