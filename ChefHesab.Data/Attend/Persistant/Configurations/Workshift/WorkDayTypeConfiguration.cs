...
{
    public class WorkDayTypeConfiguration : IEntityTypeConfiguration<WorkDayType>
    {
        public void Configure(EntityTypeBuilder<WorkDayType> builder)
        {
            builder.ToTable("WorkDayType", "dbo");
            builder.HasKey(x => x.Id).HasName("PK_WorkDayType").IsClustered();
            ...
            builder.Property(x => x.UseInRollCall).HasColumnName(@"UseInRollCall").HasColumnType("bit").IsRequired();
            builder.Property(x => x.IsHoliday).HasColumnName(@"IsHoliday").HasColumnType("bit").IsRequired();
            builder.Property(x => x.IsOfficialHoliday).HasColumnName(@"IsOfficialHoliday").HasColumnType("bit").IsRequired();
