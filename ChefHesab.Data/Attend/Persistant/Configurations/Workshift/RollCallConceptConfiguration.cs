...
{
    // RollCallConcept
    public class RollCallConceptConfiguration : IEntityTypeConfiguration<RollCallConcept>
    {
        public void Configure(EntityTypeBuilder<RollCallConcept> builder)
        {
            builder.ToTable("RollCallConcept", "dbo");
            builder.HasKey(x => x.Id).HasName("PK_RollCallConcept").IsClustered();
