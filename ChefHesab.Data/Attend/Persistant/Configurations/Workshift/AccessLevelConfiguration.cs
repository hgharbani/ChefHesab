...
namespace Ksc.HR.Data.Persistant.Configurations
{
    ...
    public class AccessLevelConfiguration : IEntityTypeConfiguration<AccessLevel>
    {
        ...
        {
            builder.ToTable("AccessLevel", "dbo");
            builder.HasKey(x => x.Id).HasName("PK_AccessLevel").IsClustered();
            ...
            builder.Property(x => x.RoleInIdentityService).HasColumnName(@"RoleInIdentityService").HasColumnType("nvarchar(500)").IsRequired(false).HasMaxLength(500);
