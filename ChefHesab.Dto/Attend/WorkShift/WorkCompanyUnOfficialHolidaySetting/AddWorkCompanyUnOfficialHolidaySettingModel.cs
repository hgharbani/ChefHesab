...
{
    public class AddWorkCompanyUnOfficialHolidaySettingModel
    {
        public AddWorkCompanyUnOfficialHolidaySettingModel()
        {
        ...
        public List<string> CodeCategoryJobCategorySelected { get; set; }
