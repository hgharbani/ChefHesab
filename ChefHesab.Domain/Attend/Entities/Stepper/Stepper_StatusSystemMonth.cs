...
{
    // StatusSystemMonth
    public class Stepper_StatusSystemMonth : IEntityBase<int>
    {
        ...
        /// <summary>
        /// Parent SystemSequenceStatu pointed by [StatusSystemMonth].([SystemSequenceStatusId]) (FK_EmployeeSystemStatusMonth_SystemSequenceStatus)
        /// </summary>
        public virtual SystemSequenceStatus SystemSequenceStatus { get; set; } // FK_EmployeeSystemStatusMonth_SystemSequenceStatus
    }
}
