...
{
    public interface IMilitaryExemptionReasonRepository : IRepository<MilitaryExemptionReason, int>
    {
        IQueryable<MilitaryExemptionReason> GetAllMilitaryExemptionReasonNoTracking(int id);
    }
}
