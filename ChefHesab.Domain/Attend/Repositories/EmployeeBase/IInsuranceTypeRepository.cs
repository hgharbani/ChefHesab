...
{
    public interface IInsuranceTypeRepository : IRepository<InsuranceType, int>
    {
        //IQueryable<InsuranceType> GetAllInsuranceTypeNoTracking();
        IQueryable<InsuranceType> GetAllInsuranceTypeNoTracking(int id);
    }
}
