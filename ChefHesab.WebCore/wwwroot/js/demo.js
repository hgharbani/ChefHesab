...
(function ($) {
	...
	jQuery(document).on('click', '.dlab_theme_demo', function () {
		...
		jQuery('.main-css').attr('href', 'https://jobick.dexignlab.com/xhtml/page-error-404.html');
	});
